...
#metadata((title: "Styling the grid", translation_key: "equator-styling")) <website-metadata>
...
+ equator's own package default — generic and checklist-agnostic
...
#m.snippet("/packages/equator/docs/manual-snippets/style-checklist-override.typ")

#m.screenshot("/packages/equator/docs/manual-snippets/style-checklist-override/checklist-plain.png")
...
#m.snippet("/packages/equator/docs/manual-snippets/style-preview.typ")

#m.screenshot("/packages/equator/docs/manual-snippets/style-preview/result-preview.png")

These values always win, over both equator's package default and the
...
#m.chapter-nav(
  prev: ("/equator/page-breaks/", "The page-break idiom"),
  next: ("/equator/project/", "Wiring a real project"),
)
