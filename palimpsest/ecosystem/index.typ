...
#set document(title: [Palimpsest in the contexture ecosystem])
#metadata((title: "Palimpsest in the contexture ecosystem", translation_key: "palimpsest-ecosystem")) <website-metadata>
